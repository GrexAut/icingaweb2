...
CREATE TABLE `dashboard_subscribable` (
    `dashboard_id`  binary(20) NOT NULL,
    `username`      varchar(254) NOT NULL COLLATE utf8mb4_unicode_ci,
     CONSTRAINT `fk_dashboard_share_dashboard` FOREIGN KEY (`dashboard_id`) REFERENCES dashboard (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
CREATE TABLE `module_dashlet` (
    ...
    `url`           varchar(2048) NOT NULL COLLATE utf8mb4_bin,
    `description`   varchar(64) NOT NULL COLLATE utf8mb4_unicode_ci,
